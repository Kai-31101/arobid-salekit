...
const demoScriptSteps: DemoJourneyStep[] = [
    ...
    { actor: 'Exhibitor', action: 'Click Process to Payment', screen: 'Quick Signup Popup', path: '/tradexpo/select-position', cta: 'Proceed to Payment', prep: ['Select a booth'], script: 'Trước khi payment, hệ thống hiển thị popup Quick Signup ngay trên màn hình hiện tại. Thông tin được prefill từ login / onboarding để giảm friction.' },
    { actor: 'Exhibitor', action: 'Click Quick Sign up', screen: 'Payment Success', path: '/tradexpo/select-position', cta: 'Quick Sign Up', prep: ['Select a booth', 'Proceed to Payment'], script: 'Sau Quick Signup, hệ thống chuyển đến màn hình thanh toán thành công.' },
    ...
    { actor: 'Exhibitor', action: 'Click Start Scan & Create Profile', screen: 'AI Loading → General Info', path: '/exhibitor/ai-onboarding', cta: 'Start Scan', prep: ['AroAI Onboarding'], script: 'Hệ thống hiển thị animation AI extracting trong 2 giây, sau đó chuyển sang trang General Info với dữ liệu đã được prefill.' },
    { actor: 'Exhibitor', action: 'Click Preview Profile', screen: 'General Info', path: '/exhibitor/general-info', cta: 'Preview Profile', script: 'Exhibitor có thể preview profile public trên Arobid bằng link cố định trước khi submit.' },
    ...
    { actor: 'Exhibitor', action: 'Click Expo card', screen: 'Joined Expo Detail', path: '/user/workspace/expo-dashboard', cta: 'Vietnam Furniture Expo 2026', script: 'Màn hình chi tiết Expo hiển thị như một detail page thật, không chỉ là card mở rộng. Có banner, thông tin Expo, KPI và quick actions.' },
    ...
    { actor: 'Exhibitor', action: 'Click Go To 3D Expo', screen: 'Joined Expo Detail', path: `/user/workspace/expo-dashboard/${eid}`, cta: '3D Expo', script: 'Button này mở 3D Expo bằng Shapespark link đã được cấu hình trước.' },
    { actor: 'Exhibitor', action: 'Click Invite Visitor', screen: 'Visitor Invite Modal', path: `/user/workspace/expo-dashboard/${eid}`, cta: 'Invite Visitor', script: 'Exhibitor hoặc workspace user có thể mời Visitor vào Expo. Modal reuse UI của External Invite, nhưng nội dung email được đổi sang Visitor.' },
    ...
    { actor: 'Visitor', action: 'Click Join', screen: '/tradexpo/expo-detail', path: '/visitor/invitation', cta: 'Join', script: 'Visitor được đưa vào Expo Detail Page, nhưng không có auto-scroll animation. Trang đứng ở banner đầu tiên để Visitor chủ động xem nội dung.' },
    { actor: 'Visitor', action: 'Click Virtual Lobby', screen: 'TradeXpo Banner', path: '/tradexpo/expo-detail', cta: 'Virtual Lobby', script: 'Trong banner Expo Detail có CTA Virtual Lobby. Visitor có thể vào ngay không gian 3D Expo.' },
